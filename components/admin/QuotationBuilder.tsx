...
export function QuotationBuilder({
  ...
  const [formData, setFormData] = useState({
    ...
    delivery_collection: initialData?.delivery_collection || (searchParams.get("street") ? "Delivery" : "Collection"),
    delivery_address_line1: initialData?.delivery_address_line1 || searchParams.get("street") || "",
    delivery_address_line2: initialData?.delivery_address_line2 || searchParams.get("state") || "",
    delivery_city: initialData?.delivery_city || searchParams.get("city") || "",
    delivery_postcode: initialData?.delivery_postcode || searchParams.get("postcode") || "",
